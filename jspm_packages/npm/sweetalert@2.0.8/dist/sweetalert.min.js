  ...
  !function(t, e) {
    ...
    return function(t) {
      ...
      e.onAction = function(t) {
        ...
        for (var t = document.querySelectorAll("." + c),
            e = 0; e < t.length; e++) {
      ...
      (function(t, e) {
        !function(t, n) {
          ...
          function o(t) {
            ...
            for (var e = new Array(arguments.length - 1),
                n = 0; n < e.length; n++)
              e[n] = arguments[n + 1];
            var o = {
              callback: t,
      ...
      function o(t, e) {
        ...
        for (var n = Object(t),
          ...
          var r = arguments[o];
          if (void 0 !== r && null !== r)
            for (var i = Object.keys(Object(r)),
                a = 0,
                s = i.length; a < s; a++) {
              var c = i[a],
